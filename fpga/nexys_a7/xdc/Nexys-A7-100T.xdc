...
# BLG FOR COMPATIBILITY PURPOSE
# I HAVE TO FIND A BETTER SOLUTION...
set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33} [get_ports CLK_12MHz]
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports CLK_12MHz]
